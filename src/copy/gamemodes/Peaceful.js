...
export default {
  ...
  infoBlurb: `True to it's name, the PeacefulCraft Network has a peaceful survival world. The
    peaceful world has all the same amenities as the normal survival world; unlimited homes,
    teleporting, keep inventory, etc, just without the mobs. Player's can move between the normal

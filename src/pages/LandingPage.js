...
import { toWebpBackgroundImage } from '@/utils/imageFormat';
			...
			m('div#landing_page_content', [
				...
				m(GridImageModal, {
					images: [
						...
						{ 
							img: toWebpBackgroundImage(Northridge),
						...
						{ 
							img: toWebpBackgroundImage(Creative),
				...
				m(GridImageModal, {
					images: [
						{ 
							img: toWebpBackgroundImage(InstagramBanner),
						...
						{ 
							img: toWebpBackgroundImage(TwitterBanner),
						...
						{ 
							img: toWebpBackgroundImage(TwtichBanner),
				...
				m(GridImageModal, {
					images: [
						{ 
							img: toWebpBackgroundImage(DiscordBanner),
							alt: 'Discord Logo',
							title: 'Discord',
						...
						{ 
							img: toWebpBackgroundImage(ForumsBanner),
							alt: 'Forum Icon',
							title: 'Forums',
						...
						{ 
							img: toWebpBackgroundImage(GitHub),
							alt: 'GitHub Logo',
